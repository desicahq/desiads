...
export default function Header() {
    return (
        ...
        <header className="h-screen flex flex-col justify-content-center items-center">
          ...
          <br />
          <br />
          <form className="relative text-gray-700" action="https://mail.desica.uk/subscription/form" method="POST">
          ...
          <input id="d711c" type="checkbox" name="l" value="d711c01e-83f3-4657-8a2b-fb33dfd9c208" className="hidden" checked readOnly />
        </form>
            </div>
            <Wave />
        </header>
